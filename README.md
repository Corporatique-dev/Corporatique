...
Data extraction application ([DMS]). Allows you to extract the text from different filetypes (.pdf, .doc, ...)
Made in Java, has a plugin management system.

See the source of the plugins already made : [Corpoplugins]

The javadoc is available here :[doc](http://corporatique-dev.github.io/Corporatique/javadoc)
